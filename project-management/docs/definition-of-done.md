...
**Related**: [FR-036 Documentation-Code Consistency Review](../../backlog/features/FR-036-documentation-code-consistency-review.md)
...
- [Sprint Planning Template](templates/sprint-planning-template.md) — Checklist
