# Bug Fix: BF-010 - Greeting Response Causes "Something Went Wrong" (Parse Entities Error)
...
- [FR-024: Greeting Response and Command Discovery](../features/FR-024-greeting-and-command-help.md)
