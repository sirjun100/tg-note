# Bug Fix: BF-016 - /dream Parse Error: User Receives Nothing in Telegram
...
BF-014 added a try/except with plain-text fallback. Possible causes for this regression:
...
- [BF-014: /dream Parse Entities Error](BF-014-dream-parse-entities-error.md) — initial fix with fallback
