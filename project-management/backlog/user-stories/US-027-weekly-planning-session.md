# User Story: US-027 - Weekly Planning Session
...
- US-012: Google Tasks Integration (required - for task list)
- US-017: Brain Dump Session (reference - similar conversation flow)
- US-007: Conversation State Management (required)
- US-014: Daily Report (optional - can reference report data)
