# User Story: US-034 - Joplin Projects ↔ Google Tasks Sync (Project = Task, Tasks = Subtasks)
...
| Principle | How US-034 supports it |
|-----------|------------------------|
...
- [US-016: Joplin Reorganization (PARA)](US-016-joplin-database-reorganization.md)
- [Google Tasks API - tasks.insert](https://developers.google.com/tasks/reference/rest/v1/tasks/insert)
