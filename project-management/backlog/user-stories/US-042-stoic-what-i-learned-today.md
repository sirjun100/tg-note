...
- [US-019: Stoic Journal](US-019-stoic-journal.md)
- [Stoic Journal Template](../../../src/prompts/stoic_journal_template.md)
- [DEF-009: Stoic Questions Template Mismatch](../defects/DEF-009-stoic-questions-template-mismatch.md) — ensure template and code stay aligned
