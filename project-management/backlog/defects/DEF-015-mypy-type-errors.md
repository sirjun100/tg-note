# Defect: DEF-015 - Mypy Type Errors (60 errors in 23 files)
...
- [DEF-012: Mypy Module Resolution](DEF-012-mypy-module-resolution.md) — fixed with --explicit-package-bases
