# Bug Report: DEF-008 - Stoic Journal: Evening Reflection Deletes Morning Reflection
...
- 2026-03-04 - Created as DEF-008 - Critical data loss issue
- 2026-03-06 - Verified fixed: `_check_section_exists()` + `/stoic_replace` / `/stoic_append` prompt when section exists (fixed in DEF-005)
