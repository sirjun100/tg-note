# Feature Request: FR-044 - /project_new Command to Create Project with Default Folders
...
- [FR-016: Joplin Database Reorganization](FR-016-joplin-database-reorganization.md)
...
**Sprint 15**: See [sprint-15-implementation-guide.md](../../sprints/sprint-15-implementation-guide.md) § FR-044 for full `create_project()` and handler code. Key: `ReorgOrchestrator.create_project`, `get_or_create_folder_by_path`, `create_note`, register in `reorg.py`.
