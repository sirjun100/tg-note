# Feature Request: FR-035 - World-Class Brain Dump Experience
...
| **Triggers** | Not implemented | FR-017 suggested "think about boss/health" — never added |
...
### 3. Cognitive Triggers (from FR-017 Notes)
...
- **Scheduler**: Reuse existing scheduler for brain dump reminders (see FR-032 habit tracking)
...
- [FR-017 GTD Expert Persona](FR-017-gtd-expert-persona.md) — original design, Notes section (triggers)
- [FR-032 Habit Tracking](FR-032-habit-tracking.md) — recurrence integration
...
- FR-007 (Conversation State Management) — must support DB persistence for recovery
- FR-032 (Habit Tracking) — for recurrence/reminder integration (optional)
